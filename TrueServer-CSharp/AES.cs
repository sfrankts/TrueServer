...
namespace TrueServer_CSharp
{
    class AES
    {
        ...
        public byte[] GetPasswordBytes(string saltTxt)
        {
            ...
            string plain = saltTxt;
            var sc = new SecureString();
            foreach (char c in plain) sc.AppendChar(c);
            sc.MakeReadOnly();
            ...
            else
            {
                ...
                IntPtr unmanagedBytes = Marshal.SecureStringToGlobalAllocAnsi(sc);
                try
                {
